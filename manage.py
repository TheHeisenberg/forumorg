...
def set_registered_false():
    return get_db().users.update_many({},{'$set' : {'events' : {'fra' : {'registered':False}, 'joi':{'registered':False }, 'styf':{'registered':False}, 'master_class':{'registered' : False}}}})

#######################################
#change admin password
@manager.command
def set_admin_password(password):
    return get_db().companies.update_one({'id':"admin"},{'$set' : {'password' :password }})
#######################################

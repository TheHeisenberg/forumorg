...
def index(page='index'):
    ...
    if page in ['master-class','journee-objectif-ingenieur','start-up-your-future','reset_password']:
...
def reset_password_request():
    if request.method == 'POST':
        ...
        if not user:#user not found in db
            ...
            #send the confiramtion mail
            send_mail(email, confirm_url,'dd8c6e2a-7d33-42e5-b749-1354c1b357d6')#use the passwordreset template
